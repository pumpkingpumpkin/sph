            ...
            <div class="cart-body">
                <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
                    ...
                    <li class="cart-list-con5">
                        ...
                        <input type="text" :value="cart.skuNum" @change="handler('change',$event.target.value*1,cart)">
...
export default {
    ...
    computed:{
        ...mapGetters(['cartList']),
        cartInfoList(){return this.cartList.cartInfoList||[]},
        totalPrice(){
            let sum=0
