                    ...
                    <div class="tab-pane active">
                        ...
                        <ul class="goodsList">
                            ...
                            <li>
                                <div class="list-wrap">
                                    <div class="p-img">
                                        <img src="../../assets/images/part02.png" alt="">
                                    </div>
                                    <div class="attr">
                            ...
                            <li>
                                <div class="list-wrap">
                                    <div class="p-img">
                                        <img src="../../assets/images/part03.png" alt="">
                                    </div>
                                    <div class="attr">
                                        <em>Apple苹果iPhone 6s (A1699)</em>
                                    </div>
                ...
                <div class="fitting">
                    ...
                    <div class="good-suits">
                        ...
                        <ul class="suits">
                            ...
                            <li class="suitsItem">
                                <img src="../../assets/images/dp02.png" alt="">
                                <p>Feless费勒斯VR</p>
                                <label>
                            ...
                            <li class="suitsItem">
                                <img src="../../assets/images/dp03.png" alt="">
                                <p>Feless费勒斯VR</p>
                                <label>
                            ...
                            <li class="suitsItem">
                                <img src="../../assets/images/dp04.png" alt="">
                                <p>Feless费勒斯VR</p>
                                <label>
